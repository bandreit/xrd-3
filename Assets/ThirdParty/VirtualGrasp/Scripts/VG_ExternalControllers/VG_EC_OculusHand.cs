...
public class VG_EC_OculusHand : VG_ExternalController
{
	...
	public VG_EC_OculusHand(int avatarID, VG_HandSide side)
	{
        ...
        m_enabled = true;
#else
		VG_Debug.LogError("You want an OculusHand controller, but have not defined VG_USE_OCULUS_CONTROLLER at the top of this file.");
		m_enabled = false;
#endif
	}
	...
	private Matrix4x4 modifyPose(Matrix4x4 rawPose, bool isWrist)
    {
        /*
        // MegaPack
        return Matrix4x4.TRS(rawPose.GetColumn(3),
